...
public class Doorman {
  ...
  //generate a random number, commandCount, to determine how many times the door should be opened and closed. You set commands by iterating from 0 to commandCount and returning either an OpenCommand or CloseCommand based on whether or not the index is even.
